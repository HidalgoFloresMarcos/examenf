...
import {Aplicacion, Perfil, RespuestaReporte} from "./interfaces";
...
export class ApiService {
  ...
  obtenerReporte():Observable<RespuestaReporte>{
    return this.http.post<RespuestaReporte>("http://localhost:8080/obtenerReporte", null,this.httpOptions )
      .pipe(
        retry(1),
