...
@Component({
  selector: 'app-registrarapp',
  templateUrl: './registrarapp.component.html',
  styleUrls: ['./registrarapp.component.scss']
})
export class RegistrarappComponent implements OnInit {
